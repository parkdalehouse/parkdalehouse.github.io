...
REG_CSS = '''
  ...
  @media(max-width:860px){
    .reg{grid-template-rows:auto auto auto auto;padding-bottom:84px}
    .reg-main{grid-template-columns:1fr;gap:2rem;padding:1.6rem 1.4rem 2rem}
    .reg-bar{padding:1.1rem 1.4rem 0}
    .reg-meta{padding:0 1.4rem .9rem}
    .reg-cap{text-align:left;flex:1 0 100%}
    .reg-foot{gap:1.4rem;padding:.9rem 1.4rem 1.1rem}
    .reg-line{max-width:none}
  }
...
<div class="reg tone-deep" id="top">
  ...
  <main class="reg-main">
    ...
    <div class="reg-card">
      ...
      <div class="form-done tone-deep" id="done"><b>Thank you.</b><br>The leasing team will follow up within one business day.</div>
      <p class="reg-fine">Realtors are welcome to register on behalf of a client.</p>
      <p class="reg-fine">Prefer to talk? <a href="tel:+14164519499">416.451.9499</a>, answered live, 24 hours a day.</p>
    </div>
  </main>
...
def main():
    ...
    for need in ('id="fn"', 'id="ln"', 'id="em"', 'id="ph"', 'id="waitlist"',
                 'id="done"', 'class="wm-stack"', 'id="regdots"',
